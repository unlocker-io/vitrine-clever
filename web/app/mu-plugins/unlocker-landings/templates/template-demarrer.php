 ...
 * theme_page_templates + template_include (inc/templates.php). The form
 * posts to inc/lead.php's REST endpoint via assets/flow.js; #ul-website is
 * a honeypot (hidden, off-canvas, read by id -- never submit-blocking).
 * #ul-form-error surfaces a submission failure (role="alert", toggled by
 * flow.js), hidden by default.
 *
